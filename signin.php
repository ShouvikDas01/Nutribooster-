      ...
      <div class="row gx-lg-5 align-items-center mb-5">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
          ...
          if (isset($_SESSION['registration_success'])) {
            ...
            echo '  Swal.fire({';
            echo '    title: "Success",';
            echo '    text: "' . $_SESSION['registration_success'] . '",';
            echo '    icon: "success",';
          ...
          if (isset($_SESSION['login_failed'])) {
            ...
            echo '  Swal.fire({';
            echo '    title: "Oops!",';
            echo '    text: "' . $_SESSION['login_failed'] . '",';
            echo '    icon: "error",';
            echo '    showConfirmButton: false,';
            echo '    timer: 1000';
            echo '  });';
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
              <form id="loginForm" action="backend_file.php" method="POST" onsubmit="return validateLogin();"> <!-- Change the form action to your login processing script -->
                ...
                <div class="form-text mb-3">
                  <a href="forgotpassword.php" style="color: hsl(9, 89%, 31%);">Forgot Password?</a>
                </div>

                <!-- New customer? Create Account link -->
                <p class="opacity-70" style="color: hsl(220, 84%, 5%);">
                  New customer? <a href="signup.php" style="color: hsl(9, 89%, 31%);">Create Account</a>
                </p>
              </form>
            </div>
          </div>
